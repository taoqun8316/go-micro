...
type CartService interface {
	AddCart(ctx context.Context, in *CartInfo, opts ...client.CallOption) (*AddResponse, error)
...
func (c *cartService) AddCart(ctx context.Context, in *CartInfo, opts ...client.CallOption) (*AddResponse, error) {
...
type CartHandler interface {
	AddCart(context.Context, *CartInfo, *AddResponse) error
...
func RegisterCartHandler(s server.Server, hdlr CartHandler, opts ...server.HandlerOption) error {
	type cart interface {
		AddCart(ctx context.Context, in *CartInfo, out *AddResponse) error
...
func (h *cartHandler) AddCart(ctx context.Context, in *CartInfo, out *AddResponse) error {
